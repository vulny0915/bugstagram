...
const SubscribePost = () => {
	...
	const deletePost = (postId, state) => {
		if(postId.PostedBy._id === state.user._id){
			axios.delete(`http://54.180.20.161:5000/deletepost/${postId._id}`, config).then((res) => {
